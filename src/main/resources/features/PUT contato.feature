Feature: PUT contato
  ...
  @Positive
  Scenario: status code 200: Editar contato
    Given I have baseURI "herokuapp"
    ...
    * I send the body
    """
        {
            "name": "bruna",
            "last_name": "valnei editado",
            "email": "bruna.editado@gmail.com",
            "age": "38",
            "phone": "11999999998",
            "address": "Rua dos testes editados",
            "state": "São Paulo",
            "city": "São Paulo"
        }
    """
  ...
  Scenario Outline: status code 422: <testDescription>
    Given I have baseURI "herokuapp"
    Given I have basePath "/contacts/1944"
    * I send the body
    """
        {
            "name": "<name>",
